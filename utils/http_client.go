...
func Get(url string, args ...interface{}) error {
	...
	return request(GET_METHOD, url, args...)
}
...
func Delete(url string, args ...interface{}) error {
	...
	return request(DELETE_METHOD, url, args...)
}
...
func Post(url string, args ...interface{}) error {
	...
	return request(POST_METHOD, url, args...)
}

func request(method string, url string, args ...interface{}) error {
